...
class Game {
  ...
  Future<void> autoPlay(activePlayer) async {
    ...
    if (Player.playerO.containsAll(0, 2) && emptyCells.contains(1))
      ...
      index = 5;
    //O-end-start
    if (Player.playerO.containsAll(2, 1) && emptyCells.contains(0))
      index = 0;
      ...
      index = 2;
    else if (Player.playerO.containsAll(6, 3) && emptyCells.contains(60))
      index = 0;
    ...
    if (Player.playerX.containsAll(2, 1) && emptyCells.contains(0))
      ...
      index = 2;
    else if (Player.playerX.containsAll(6, 3) && emptyCells.contains(60))
      index = 0;
